...
function _type(ele) {
    ...
    if (returnObj.type == "number") {
        ...
        returnObj.isPhoneNumber = returnObj.length === 10 ? true : false;
    ...
    if (returnObj.type == "string") {
        ...
        returnObj.isPhoneNumber = false;
        if (ele.length == 14) {
            console.log(ele)
            if (ele.charAt(0) == "(" && ele.charAt(4) == ")" && ele.charAt(5) == " " && ele.charAt(9) == "-") {
                if (_type(ele.substring(1,3)).isNumber) {
                    if (_type(ele.substring(6,8)).isNumber) {
                        if (_type(ele.substring(10,14)).isNumber) {
                            returnObj.isPhoneNumber = true;
                        }
                    }
                }
            }
        ...
        if (ele.length == 12) {
            console.log(ele)
            if (ele.charAt(3) == "-" && ele.charAt(7) == "-") {
                if (_type(ele.substring(0,2)).isNumber) {
                    if (_type(ele.substring(4,6)).isNumber) {
                        if (_type(ele.substring(8,11)).isNumber) {
                            returnObj.isPhoneNumber = true;
                        }
                    }
                }
